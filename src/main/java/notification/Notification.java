...
public enum Notification {
    ...
    NAME_FILTERED("",null , "","" ),
    NAME_FILTERED_DUPLICATE("",null , "","" ),
    CATEGORY_FILTER_DELETED("",null , "","" ),
    NAME_FILTER_DELETED("",null , "","" ),
    SORTED("",null , "","" ),
    INVALID_MIN_PRICE("",null , "","" ),
    MIN_PRICE_BIGGER_THAN_MAX_PRICE("",null , "","" ),
    SET_PRICE_FILTERS("",null , "","" ),
    SORT_DISABLED("",null , "","" ),
    DECLINE_REQUEST("The Request Declined", Alert.AlertType.INFORMATION, "Information" , "Request Info"),
    DELETE_USER("User Deleted", Alert.AlertType.INFORMATION, "Information" , "Delete Info"),
    PRODUCT_NOT_AVAILABLE("Product Not Available", Alert.AlertType.ERROR, "Error" , "Product Info"),
    ADD_COMMENT("",null , "","" ),
    UPDATE_SCORE("",null , "","" ),
    SET_SCORE("",null , "","" ),
    DELETED_DISCOUNT("Discount Deleted", Alert.AlertType.INFORMATION, "Information" , "Discount Info" ),
    INVALID_FINISH_DATE_EARLIER_THAN_CURRENT_DATE("Finish Date Must Be After Current Date", Alert.AlertType.ERROR, "Error" , "Discount Info"  ),
    ACCEPT_OFF_REQUEST("",null , "","" ),
    OFF_EDITING_ACCEPTED("",null , "","" ),
    OFF_EDITING_DECLINED("",null , "","" ),
    ACCEPTING_COMMENT("",null , "","" ),
    DECLINE_COMMENT("",null , "","" ),
    ACCEPT_ADDING_PRODUCT("",null , "","" ),
    ACCEPT_EDITING_PRODUCT("",null , "","" ),
    ...
    Notification(String message, Alert.AlertType alertType, String title, String header) {
